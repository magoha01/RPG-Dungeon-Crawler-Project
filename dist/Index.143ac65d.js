...
var volumeSlider = document.querySelector('#volume-control'); // const music = document.getElementById('background_music');
...
function loadGame() {
  ...
  document.getElementById('playerName').innerHTML = "".concat(player.Name);
  document.getElementById('roomIdTester').innerHTML = "".concat(player.room);
  roomArr[player.room].enemyPresent = null;
